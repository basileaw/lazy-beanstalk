...
def main():
    ...
    readme = (
        urlopen(
            "https://raw.githubusercontent.com/bazeindustries/lazy-beanstalk/main/README.md"
        )
        .read()
        .decode("utf-8")
    )
